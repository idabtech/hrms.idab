{{ Form::open(['url' => 'peark', 'method' => 'post']) }}
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group">
            {{ Form::label('peark_coupon', __('Peark Coupon'), ['class' => 'col-form-label']) }}
            {{ Form::number('peark_coupon', null, ['class' => 'form-control ', 'required' => 'required','placeholder'=>'Enter Coupon code']) }}
        </div>
    </div>
</div>
