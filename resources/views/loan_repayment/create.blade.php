{{ Form::open(['route' => ['loan-repayment.store'], 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::text('title', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter repayment title')]) }}
        </div>
        <div class="form-group col-md-6">
