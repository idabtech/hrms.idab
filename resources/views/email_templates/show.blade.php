            ...
            <div class="card mb-0 h-100">
                <div class="card-header card-body">
                    ...
                    <div class="row text-xs">
                        ...
                        @elseif($emailTemplate->slug == 'attendance_request')
                            <div class="row">
                                <p class="col-6">{{ __('App Name') }} :
                                    <span class="pull-end text-primary">{app_name}</span>
                                </p>
                                <p class="col-6">{{ __('Receiver Name') }} :
                                    <span class="pull-right text-primary">{receiver_name}</span>
                                </p>
                                <p class="col-6">{{ __('Employee Name') }} :
                                    <span class="pull-right text-primary">{employee_name}</span>
                                </p>
                                <p class="col-6">{{ __('Employee Email') }} :
                                    <span class="pull-right text-primary">{employee_email}</span>
                                </p>
                                <p class="col-6">{{ __('Request Type') }} :
                                    <span class="pull-right text-primary">{type}</span>
                                </p>
                                <p class="col-6">{{ __('Date') }} :
                                    <span class="pull-right text-primary">{date}</span>
                                </p>
                                <p class="col-6">{{ __('Time') }} :
                                    <span class="pull-right text-primary">{time}</span>
                                </p>
                                <p class="col-6">{{ __('Reason') }} :
                                    <span class="pull-right text-primary">{reason}</span>
                                </p>
                                <p class="col-6">{{ __('App Url') }} :
                                    <span class="pull-right text-primary">{app_url}</span>
                                </p>
                                <p class="col-6">{{ __('URL') }} :
                                    <span class="pull-right text-primary">{url}</span>
                                </p>
                            </div>
