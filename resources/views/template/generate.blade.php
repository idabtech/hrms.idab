...
<form action="" id="myForm">
    ...
    <div class="form-group response">
        <a class="btn btn-primary btn-sm float-left" href="javascript:void(0)" id="generate">{{ __('Generate') }}</a>
        <a href="javascript:void(0)" onclick="copyText()" class="btn btn-primary btn-sm float-end"><i
                class="ti ti-copy"></i>{{ __('Copy Text') }}</a>
        <a href="javascript:void(0)" onclick="copySelectedText()" class="btn btn-primary btn-sm float-end me-2 selected_text"><i
    ...
    $('body').on('click', '#generate', function() {
        ...
        $.ajax({
            ...
            afterSend: function(msg) {
                $("#generate2").empty();
                var html =
                    `<a class="btn btn-primary" href="javascript:void(0)" id="generate">{{ __('Generate') }}</a>`;
