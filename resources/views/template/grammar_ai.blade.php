...
<div class="response">
    ...
    <a class="btn btn-primary btn-sm float-left" href="javascript:void(0)" id="regenerate">{{ __('Re Generate') }}</a>
    <a href="javascript:void(0)" onclick="copyGrammerText()" class="btn btn-primary btn-sm float-end "><i class="ti ti-copy"></i>
        {{ __('Copy Text') }}</a>
    ...
    $('body').on('click', '#regenerate', function() {
        ...
        $.ajax({
            ...
            afterSend: function(msg) {
                $("#regenerate").empty();
                var html =
                    `<a class="btn btn-primary" href="javascript:void(0)" id="regenerate">{{ __('Generate') }}</a>`;
