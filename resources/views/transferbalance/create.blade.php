    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('from_account_id', $accounts, null, ['class' => 'form-control select2','id'=>'from_account' ,'required' => 'required', 'placeholder' => __('Choose Account')]) }}
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('to_account_id',[], null, ['class' => 'form-control ','id'=>'to_account' , 'required' => 'required', 'placeholder' => __('Choose Account')]) }}
                <div class="text-xs mt-1">
                    {{ __('Create account.') }} <a href="{{ route('accountlist.index') }}"><b>{{ __('Click here') }}</b></a>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="text-xs mt-1">
                    {{ __('Create payment method.') }} <a href="{{ route('paymenttype.index') }}"><b>{{ __('Click here') }}</b></a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
