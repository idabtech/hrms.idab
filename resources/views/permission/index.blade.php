                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between w-100">
                                        ...
                                        {{-- <a href="javascript:void(0)" data-url="{{ route('permissions.create') }}" data-size="lg" data-ajax-popup="true" data-title="Create New Permission" class="btn btn-icon icon-left btn-primary"> --}}
