...
<div class="modal-body">
    ...
    <div class="text-end">
        <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true" data-url="{{ route('generate', ['interview-schedule']) }}"
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <div class="text-xs mt-1">
                {{ __('Create candidate.') }} <a href="{{ route('job-application.index') }}"><b>{{ __('Click here') }}</b></a>
            </div>
        </div>
        <div class="form-group col-md-6">
            ...
            <div class="text-xs mt-1">
                {{ __('Create interviewer.') }} <a href="{{ route('employee.index') }}"><b>{{ __('Click here') }}</b></a>
            </div>
        </div>
        <div class="form-group col-md-6">
