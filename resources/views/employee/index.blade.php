...
@section('action-button')
    <a href="javascript:void(0)" data-url="{{ route('employee.file.export') }}" data-ajax-popup="true" data-bs-toggle="tooltip"
        data-bs-placement="top" data-title="{{ __('Export Employee Excel File') }}" class="btn btn-sm btn-primary"
