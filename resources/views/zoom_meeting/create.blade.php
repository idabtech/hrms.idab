...
<div class="modal-body">
    ...
    <div class="text-end">
        <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true" data-url="{{ route('generate', ['zoom-meeting']) }}"
            ...
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    ...
                    <div class="text-xs mt-1">
                        {{ __('Create user.') }} <a href="{{ route('employee.index') }}"><b>{{ __('Click here') }}</b></a>
                    </div>
                </div>
            </div>
        </div>
