    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                {{ Form::number('days', null, ['class' => 'form-control', 'placeholder' => __('Enter Days / Year'), 'min' => '0']) }}
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="d-flex gap-3 mt-1">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="is_paid" id="is_paid_yes" value="1"
                            {{ $leavetype->is_paid ? 'checked' : '' }}>
