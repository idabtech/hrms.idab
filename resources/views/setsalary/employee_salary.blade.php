                        ...
                        <div class="card-body">
                            <div class="project-info d-flex text-sm">
                                ...
                                <div class="project-info-inner mr-3 col-6">
                                    ...
                                    {{-- <div class="project-amnt pt-1">{{$gross_salary }}</div> --}}
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('Type') }}</th>
                                            <th>{{ __('Amount') }}</th>
                                            @can(['Edit Allowance', 'Delete Allowance'])<th>{{ __('Action') }}</th>@endcan
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                @can('Create Saturation Deduction')
                                    <div class="col text-end">
                                        <a  data-url="{{ route('saturationdeductions.create', $employee->id) }}"
                                            data-ajax-popup="true" data-size="lg" data-title="{{ __('Create Taxes') }}"
                                            data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                                            data-bs-original-title="{{ __('Create') }}">
                                            <i class="ti ti-plus"></i>
                                        </a>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('Amount') }}</th>
                                            {{-- <th>{{ __('PT') }}</th> --}}
                                            @can(['Edit Saturation Deduction', 'Delete Saturation Deduction'])<th>{{ __('Action') }}</th>@endcan
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="Action">
                                                    <span>
                                                        ...
                                                        @can('Delete Saturation Deduction')
                                                            <div class="action-btn bg-danger ms-2">
                                                                {!! Form::open(['method' => 'DELETE', 'route' => ['pension.destroy', $data->id], 'id' => 'delete-form-' . $data->id]) !!}
                                                                <a
                                                                    class="mx-3 btn btn-sm  align-items-center bs-pass-para"
                                                                    data-bs-toggle="tooltip" title=""
                                                                    data-bs-original-title="Delete" aria-label="Delete"><i
                                ...
                                <table class="table">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ __('Type') }}</th>
                                            <th>{{ __('Amount') }}</th>
                                            @can(['Edit Commission', 'Delete Commission'])<th>{{ __('Action') }}</th>@endcan
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('Start Date') }}</th>
                                            <th>{{ __('End Date') }}</th>
                                            @can(['Edit Loan', 'Delete Loan'])<th>{{ __('Action') }}</th>@endcan
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                {{-- @can('Create Other Payment') --}}
                                    <div class="col text-end">
                                        ...
                                        <a  data-url="{{ route('employee.peark.create', $employee->id) }}"
                                            data-ajax-popup="true" data-title="{{ __('Create Peark') }}"
                                            data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary"
                                            data-bs-original-title="{{ __('Create') }}">
                                            <i class="ti ti-plus"></i>
                                        </a>
                                                ...
                                                <td class="Action">
                                                    <span>
                                                        ...
                                                        {{-- @can('Delete Other Payment') --}}
                                                            <div class="action-btn bg-danger ms-2">
                                                                {!! Form::open(['method' => 'DELETE', 'route' => ['peark.destroy', $value->id], 'id' => 'delete-form-' . $value->id]) !!}
                                                                <a
                                                                    class="mx-3 btn btn-sm  align-items-center bs-pass-para"
                                                                    data-bs-toggle="tooltip" title=""
                                                                    data-bs-original-title="Delete" aria-label="Delete"><i
                                            ...
                                            <tr>
                                                ...
                                                <td class="Action">
                                                    <span>
                                                        ...
                                                        {{-- @can('Delete Other Payment') --}}
                                                            <div class="action-btn bg-danger ms-2">
                                                                {!! Form::open(['method' => 'DELETE', 'route' => ['bonous.destroy', $item->id], 'id' => 'delete-form-' . $item->id]) !!}
                                                                <a
                                                                    class="mx-3 btn btn-sm  align-items-center bs-pass-para"
                                                                    data-bs-toggle="tooltip" title=""
                                                                    data-bs-original-title="Delete" aria-label="Delete"><i
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('Hours') }}</th>
                                            <th>{{ __('Rate') }}</th>
                                            @can(['Edit Overtime', 'Delete Overtime']) <th>{{ __('Action') }}</th>@endcan
                                        </tr>
                                    </thead>
                                    <tbody>
