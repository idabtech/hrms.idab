{{ Form::open(['route' => 'salary-revision.store', 'method' => 'POST', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('revision_type', $revisionTypes, null, [
                    'class'    => 'form-control',
                    'id'       => 'revision_type',
                    'required' => 'required',
                ]) }}
        ...
        <div class="col-12 col-md-6">
            <div class="form-group">
                ...
                <x-required></x-required>
                {{ Form::number('revision_value', null, [
                    'class'    => 'form-control',
                    'id'       => 'revision_value',
                    'step'     => '0.01',
                    'min'      => '0',
        ...
        <div class="col-12">
            <div class="alert alert-success py-2 mb-0" id="revised_salary_preview" style="display:none;">
                <span class="fw-bold">{{ __('Revised Salary will be') }}:</span>
                <span id="revised_salary_value">—</span>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 mt-3">
            <div class="form-group">
                ...
                <x-required></x-required>
                {{ Form::select('cycle_months', $cycleOptions, null, [
                    'class'    => 'form-control',
                    'required' => 'required',
                ]) }}
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary">{{ __('Schedule Revision') }}</button>
</div>
...
(function () {
    ...
    function updatePreview() {
        ...
        var preview = document.getElementById('revised_salary_preview');
