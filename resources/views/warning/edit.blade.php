...
<div class="modal-body">
    ...
    <div class="card-footer text-end">
        <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true" data-url="{{ route('generate', ['warning']) }}"
    ...
    <div class="row">
        @if (\Auth::user()->type != 'employee')
            <div class="form-group col-md-6 col-lg-6">
                ...
                {{ Form::select('warning_by', $employees_by, null, ['class' => 'form-control select2','id'=>'warning_by',  'required' => 'required']) }}
            </div>
        @endif
        <div class="form-group col-lg-6 col-md-6">
            {{ Form::label('warning_to', __('Warning To'), ['class' => 'col-form-label']) }}<x-required></x-required>
            {{ Form::select('warning_to', $employees_to, null, ['class' => 'form-control','id'=>'warning_to', 'required' => 'required']) }}
        </div>
        <div class="form-group col-lg-6 col-md-6">
        ...
        <div class="form-group col-lg-6 col-md-6">
            ...
            {{ Form::date('warning_date', null, ['class' => 'form-control d_week', 'autocomplete' => 'off' ,'required' => 'required']) }}
        </div>
