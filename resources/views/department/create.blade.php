    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::select('branch_id', $branch, null, ['class' => 'form-control branch_id','placeholder' => __('Select Branch')]) }}
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::text('slug', null, ['class' => 'form-control', 'placeholder' => __('Enter Slug')]) }}
                </div>
                @error('slug')
                    <span class="invalid-slug" role="alert">
                        <strong class="text-danger">{{ $message }}</strong>
                    </span>
                @enderror
            </div>
