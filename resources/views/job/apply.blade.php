...
<head>
    ...
    <title>
        {{ !empty($companySettings['title_text']) ? $companySettings['title_text']->value : config('app.name', 'ERPGO') }}
        - {{ $job->title }}</title>
            ...
            <div class="container pt-6">
                <div class="row row-grid justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <p class="lead lh-180"><i class="fa fa-map-marker-alt"></i>
                            ...
                            @if (!empty($job->applicant) && in_array('address', explode(',', $job->applicant)))
                                <div class="form-group col-md-12 ">
                                    {{ Form::label('address', __('Address'), ['class' => 'form-label']) }} <span
                                        class="text-danger pl-1">*</span>
                                    {{ Form::textarea('address', null, ['class' => 'form-control', 'placeholder' => 'Enter address', 'rows' => '3', 'required' => 'required']) }}
                                </div>
                                ...
                                <div class="form-group col-md-6 address">
                                    {{ Form::label('zip_code', __('Zip Code'), ['class' => 'form-label']) }} <span
                                        class="text-danger pl-1">*</span>
                                    {{ Form::text('zip_code', null, ['class' => 'form-control', 'placeholder' => 'Enter zip code', 'required' => 'required']) }}
                                </div>
                            @endif
