                    ...
                    <div class="card-body ">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                @if ($plan->enable_chatgpt == 'on')
                                    <a href="javascript:void(0)" data-size="md" class="btn btn-primary btn-icon btn-sm float-end"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                {!! Form::textarea('help_description', old('help_description', $job->help_description), [
                                    'class' => 'form-control',
                                    'rows' => 3,
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {!! Form::email('help_email', old('help_email', $job->help_email), [
                                    'class' => 'form-control',
