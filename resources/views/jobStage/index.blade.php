...
@section('action-button')
    @can('Create Job Stage')
        <a href="javascript:void(0)" data-url="{{ route('job-stage.create') }}" data-ajax-popup="true"
                        ...
                        <div class="card-body">
                            <div class="tab-content tab-bordered">
                                <div class="tab-pane fade show active" role="tabpanel">
                                    <ul class="list-unstyled conversations-list list-group sortable">
                                        @foreach ($stages as $stage)
                                            <li class="list-group-item border-0 d-flex align-items-center justify-content-between"
                                                ...
                                                <div class="d-flex justify-content-start">
                                                    ...
                                                    <h6 class=" pe-3 ps-0 mb-0 "><span>{{ $stage->title }}</span></h6>
                                                </div>
