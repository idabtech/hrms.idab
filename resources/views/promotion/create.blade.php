...
<div class="modal-body">
    ...
    <div class="card-footer text-end">
        <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true" data-url="{{ route('generate', ['promotion']) }}"
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-6 col-md-6">
            ...
            {{ Form::date('promotion_date', null, ['class' => 'form-control d_week current_date','autocomplete'=>'off' , 'required' => 'required']) }}
        </div>
