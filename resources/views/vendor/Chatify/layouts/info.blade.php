...
<div class="messenger-infoView-btns">
    {{-- <a href="javascript:void(0)" class="default"><i class="fas fa-camera"></i> default</a> --}}
    <a href="javascript:void(0)" class="danger delete-conversation"><i class="fas fa-trash-alt"></i> Delete Conversation</a>
</div>
{{-- shared photos --}}
