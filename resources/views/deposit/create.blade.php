    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <a href="javascript:void(0)" data-title="{{ __('Create Income Category') }}" onclick="modalShow([{'name' : ''}], 'create-income-category', 'Create Income Category','category')" data-bs-toggle="tooltip"
                    title="{{ __('Create Income Category') }}" class="btn btn-sm btn-primary addBtn"
                    data-bs-original-title="{{ __('Create') }}">
                    <i class="ti ti-plus"></i>
                </a>
                {{ Form::select('income_category_id', $incomeCategory, null, ['class' => 'form-control income_category_id', 'placeholder' => __('Choose a* Category')]) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <a href="javascript:void(0)" data-title="{{ __('Create Payment Type') }}" onclick="modalShow([{'name' : ''}], 'create-payment-type', 'Create Payment Type','paymenttype')" data-bs-toggle="tooltip"
                    title="{{ __('Create Payment Type') }}" class="btn btn-sm btn-primary addBtn"
                    data-bs-original-title="{{ __('Create') }}">
                    <i class="ti ti-plus"></i>
                </a>
                {{ Form::select('payment_type_id', $paymentTypes, null, ['class' => 'form-control payment_type_id', 'placeholder' => __('Choose Payment Method')]) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                switch (response.section) {
                    case 'category':
                        $('.income_category_id').html(response.output);
                        break;
                    case 'paymenttype':
                        $('.payment_type_id').html(response.output);
                        break;
                    default:
                        break;
                }
