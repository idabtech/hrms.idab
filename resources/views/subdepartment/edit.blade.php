...
<form method="POST" action="{{route('subdepartment.edit')}}"class="simple-example">
    @csrf
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="form-group">
                    ...
                    <div class="form-icon-user">
                        {{ Form::select('department', $department, $subdepartment->department, ['class' => 'form-control department_id','placeholder' => __('Select Department')]) }}
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="form-group">
                    ...
                    <div class="form-icon-user">
                        {{ Form::text('name', $subdepartment->name, ['class' => 'form-control', 'placeholder' => __('Enter SubDepartment Name')]) }}
                    </div>
                    @error('name')
    ...
    <input type="hidden" name="id" value="@if(isset($subdepartment)) {{$subdepartment->id}}  @endif">
