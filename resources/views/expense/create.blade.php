    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <a href="javascript:void(0)" data-title="{{ __('Create New  Shift') }}" onclick="modalShow([{'name' : ''}], 'create-expense-category', 'Create Expense Category','expensecategory')" data-bs-toggle="tooltip"
