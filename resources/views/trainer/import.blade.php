...
<div class="modal-footer">
    ...
    <a href="javascript:void(0)" data-url="{{ route('trainer.import.modal') }}" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Trainer CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
{{ Form::close() }}
