...
@section('action-button')
    <a href="javascript:void(0)" data-url="{{ route('trainer.file.import') }}" data-ajax-popup="true"
    ...
    @can('Create Trainer')
        <a href="javascript:void(0)" data-url="{{ route('trainer.create') }}" data-ajax-popup="true" data-size="lg"
                                            ...
                                            @if (Gate::check('Edit Trainer') || Gate::check('Delete Trainer') || Gate::check('Show Trainer'))
                                                        @can('Show Trainer')
                                                            <div class="action-btn me-2">
                                                                <a href="javascript:void(0)" class="mx-3 btn btn-sm bg-warning align-items-center"
                                                                    data-size="lg"
