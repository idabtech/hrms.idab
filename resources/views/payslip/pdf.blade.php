                            ...
                            <div class="row text-sm">
                                <div class="col-md-6">
                                    <address>
                                        ...
                                        <strong>{{ __('Position') }} :</strong> {{ $designation->name }}<br>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($payslipDetail['earning']['bonous'] as $bonous)
                                            <tr>
                                                ...
                                                <td>-</td>
                                                <td class="text-right">
                                                    {{ \Auth::user()->priceFormat($bonous->amount) }}</td>
                                            </tr>
                                        @endforeach
                                             <tr>
                                                <td>Total</td>
                                ...
                                <div class="col-lg-4 text-right text-sm">
                                    ...
                                    <div class="invoice-detail-item">
                                        ...
                                        <div class="invoice-detail-value invoice-detail-value-lg">
                                            {{ \Auth::user()->priceFormat($payslipDetail['net_salary']) }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
