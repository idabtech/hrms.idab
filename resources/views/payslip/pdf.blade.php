...
<style>
.ps-modal { background:#fff; padding:10px 14px; font-family:'Segoe UI',Arial,sans-serif; font-size:12.5px; color:#1c1c1c; }
.ps-modal * { box-sizing:border-box; }
.ps-bar { display:flex; justify-content:flex-end; align-items:center; gap:8px; margin-bottom:14px; }
.ps-card { border:2px solid {{ $_themeColor }}; border-radius:4px; overflow:hidden; max-width:800px; margin:0 auto; }
.ps-hdr { background:{{ $_themeColor }}12; border-bottom:2px solid {{ $_themeColor }}; }
...
.ps-title { background:{{ $_themeColor }}; color:#fff; text-align:center; font-size:18px; font-weight:700; letter-spacing:2px; padding:10px 0; }
.ps-band { background:{{ $_themeColor }}; color:#fff; font-weight:700; font-size:12px; text-align:center; padding:5px 10px; }
.ps-t { width:100%; border-collapse:collapse; }
.ps-t td, .ps-t th { border:1px solid {{ $_themeColor }}55; padding:6px 10px; vertical-align:middle; font-size:12px; }
.ps-t th { background:{{ $_themeColor }}22; color:{{ $_themeColor }}; font-weight:700; text-align:center; font-size:11.5px; }
.ps-t tbody tr:nth-child(even) td { background:{{ $_themeColor }}08; }
...
.v-teal  { color:{{ $_themeColor }}; font-weight:700; }
.ps-total td { background:{{ $_themeColor }}25 !important; font-weight:700; color:{{ $_themeColor }}; border-top:2px solid {{ $_themeColor }} !important; }
.ps-net-row { border-top:1px solid {{ $_themeColor }}55; }
.ps-stamp-td { width:50%; text-align:center; padding:18px 10px; border-right:1px solid {{ $_themeColor }}55; vertical-align:middle; }
.ps-stamp-ring { display:inline-block; width:82px; height:82px; border-radius:50%; border:3px solid {{ $_themeColor }}; color:{{ $_themeColor }}; font-size:8.5px; font-weight:700; text-align:center; line-height:1.4; padding:14px 6px; }
.ps-stamp-img { display:inline-block; width:90px; height:90px; border-radius:50%; object-fit:contain; border:3px solid {{ $_themeColor }}44; }
.ps-net-td { width:50%; vertical-align:middle; padding:0; }
.ps-net-inner { width:100%; border-collapse:collapse; height:100%; }
.ps-net-lbl { background:{{ $_themeColor }}25; font-weight:700; font-size:13px; color:{{ $_themeColor }}; text-align:center; padding:16px 14px; border:1px solid {{ $_themeColor }}55; width:55%; }
.ps-net-val { font-weight:700; font-size:20px; color:{{ $_themeColor }}; text-align:center; padding:16px 14px; border:1px solid {{ $_themeColor }}55; }
...
.ps-sig { border-top:1px solid {{ $_themeColor }}55; padding:14px 20px 8px; }
...
.ps-footer { background:{{ $_themeColor }}; color:#fff; }
            ...
            <tr>
                ...
                <td style="width:28%; padding:0; border-left:1px solid {{ $_themeColor }}55; border-right:1px solid {{ $_themeColor }}55; vertical-align:top;">
                    ...
                    <table class="ps-t">
                        ...
                        <tr style="background:#fff8e1;">
                            ...
                            <td class="ra" style="color:#856404; font-weight:700;">+{{ $extraDaysFmt }}</td>
                        </tr>
                        @endif
                        <tr>
                ...
                <td style="width:{{ $isHourly ? '100%' : '38%' }}; padding:0; vertical-align:top; border:none;">
                    ...
                    <table class="ps-t">
                        ...
                        <tr>
                            <td style="width:50%;" class="lbl">{{ __('Hourly Rate') }} ( <b class="v-teal">A</b> )</td>
                            <td style="width:50%;" class="ra val v-teal">{{ $_fmtMoney($perHourSalary) }}</td>
                        </tr>
                        <tr>
                            <td style="width:50%;" class="lbl">{{ __('Hours Worked') }} ( <b class="v-green">B</b> )</td>
                            <td style="width:50%;" class="ra val v-green">{{ $totalWorkHours }} hrs</td>
                        </tr>
                        <tr style="background:{{ $_themeColor }}10;">
                            <td style="width:50%;" class="lbl"><strong>{{ __('Gross Earned') }} ( <b class="v-teal">A</b> &times;  <b class="v-green">B</b> )</strong></td>
                        ...
                        <tr>
                            <td class="lbl">{{ __('Basic Salary') }}</td>
                ...
                <td class="ps-stamp-td">
                    ...
                    @else
                        <div class="ps-stamp-ring">
                            {{ $companyName }}<br>
                            <span style="font-size:7.5px; display:block; margin-top:4px; letter-spacing:1px;">{{ strtoupper($slipLabel) }}</span>
                        </div>
                    @endif
