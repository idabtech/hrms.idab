<div class="col-form-label">
    <div class="row px-3">
        ...
        <div class="col-lg-12 our-system">
            {{Form::open(array('route'=>array('payslip.updateemployee',$payslip->employee_id, $payslip->salary_month),'method'=>'post'))}}
            ...
            <div class="row">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" href="#deduction" role="tab" aria-controls="pills-contact" aria-selected="false">{{__('Statutory Deductions')}}</a>
                    </li>
                    <li class="nav-item">
