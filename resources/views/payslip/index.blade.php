            ...
            <div class="card-header">
                ...
                <div class="d-flex align-items-center justify-content-end">
                    ...
                    {{-- <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12 mx-2"> --}}
                        ...
                        <input type="hidden" name="filter_department" class="filter_department">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function callback() {
                ...
                $('.filter_department').val(department);
            ...
            $(document).on("change", ".month_date,.year_date,.deepartment", function() {
                callback();
            });
