...
@section('action-button')
    @can('Create Contract Type')
        <div class="col-auto pe-0">
            <a href="javascript:void(0)" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top"
                title="{{ __('Create') }}" data-ajax-popup="true" data-size="md" data-title="{{ __('Create Contract Type') }}"
                data-url="{{ route('contract_type.create') }}"><i class="ti ti-plus text-white"></i></a>
        </div>
    @endcan
@endsection
                                                        ...
                                                        <span class="float-start">
                                                            ...
                                                            @can('Delete Contract Type')
                                                                <div class="action-btn ">
                                                                    ...
                                                                    <a href="javascript:void(0)" data-bs-trigger="hover"
