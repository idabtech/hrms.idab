<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="{{ route('subdepartment') }}" class="list-group-item list-group-item-action border-0 {{ (request()->is('subdepartment*') ? 'active' : '')}}">{{__('Sub Department')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
        ...
        <a href="{{ route('wegis.index') }}" class="list-group-item list-group-item-action border-0 {{ (request()->is('wegis*') ? 'active' : '')}}">{{__('Wegis')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

        <a href="{{ route('shift.index') }}" class="list-group-item list-group-item-action border-0 {{ (request()->is('shift*') ? 'active' : '')}}">{{__('Shift')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
