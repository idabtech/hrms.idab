<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        @can('Manage Employment Type')
            <a href="{{ route('employmenttype.index') }}"
                class="list-group-item list-group-item-action border-0 {{ request()->is('employmenttype*') ? 'active' : '' }}">{{ __('Employment Type') }}
                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
            </a>
        @endcan
        ...
        @can('Create Subdepartment')
            <a href="{{ route('subdepartment') }}"
                class="list-group-item list-group-item-action border-0 {{ request()->is('subdepartment*') ? 'active' : '' }}">{{ __('Sub Department') }}
                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
            </a>
        @endcan
        ...
        @can('Create Wages')
            <a href="{{ route('wages.index') }}"
                class="list-group-item list-group-item-action border-0 {{ request()->is('wages*') ? 'active' : '' }}">{{ __('Wages') }}
                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
            </a>
        @endcan
