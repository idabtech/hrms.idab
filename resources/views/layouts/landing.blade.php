    ...
    <section id="feature" class="feature">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Features</span> All in one place IDAB
                        system
                    </h2>
                    <p class="m-0">
                        Use these awesome forms to login or create new account in your
    ...
    <section id="price" class="price-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Price</span> All in one place IDAB
                        system
                    </h2>
                    <p class="m-0">
                        Use these awesome forms to login or create new account in your
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    ...
                    <p class="text-body"> {{ __('Copyright') }}
                        {{ \App\Models\Utility::getValByName('footer_text') ? \App\Models\Utility::getValByName('footer_text') : config('app.name', 'IDAB') }}
                        {{ date('Y') }} | Design By IDAB </p>
                </div>
            </div>
        </div>
