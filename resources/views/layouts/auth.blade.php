...
<head>
    ...
    {{-- <title>{{(Utility::getValByName('header_text')) ? Utility::getValByName('header_text') : config('app.name', 'iDAB TECH')}} &dash; @yield('title')</title> --}}
    <title>
        {{ \App\Models\Utility::getValByName('title_text') ? \App\Models\Utility::getValByName('title_text') : config('app.name', 'iDAB TECH') }}
    ...
    <meta name="author" content="iDAB TECH" />
                ...
                <div class="container-fluid pe-2">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01" style="flex-grow: 0;">
                        <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active" href="mailto:support@idabtech.com">{{ __('Support') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="https://idabtech.com/terms-and-condition/">{{ __('Terms') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="https://idabtech.com/privacy-policy/">{{ __('Privacy') }}</a>
                            </li>
                            <li class="nav-item">
                                @yield('language-bar')
                            </li>
