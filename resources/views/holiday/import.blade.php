...
<div class="modal-footer">
    ...
    <a href="javascript:void(0)" data-url="" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Holidays CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
{{ Form::close() }}
