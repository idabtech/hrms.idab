...
@section('action-button')
    ...
    <a href="javascript:void(0)" data-url="{{ route('holidays.file.import') }}" data-ajax-popup="true"
    ...
    @can('Create Holiday')
        <a href="javascript:void(0)" data-url="{{ route('holiday.create') }}" data-ajax-popup="true"
