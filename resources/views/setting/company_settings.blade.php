                                            ...
                                            @if (\Auth::user()->type == 'super admin')
                                                        ...
                                                        <div class="card-body pt-0">
                                                            <div class=" setting-card">
                                                                ...
                                                                @error('company_logo_light')
                                                                    <div class="row">
                                                                        <span class="invalid-company_logo_light"
                                                                            role="alert">
                                                                            <strong
                                                                                class="text-danger">{{ $message }}</strong>
                                                                        </span>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <label for="metakeyword"
                                                        class="col-form-label">{{ __('Meta Keywords') }}
                                                    </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-check form-switch" style="margin-top:50px;">
                                            ...
                                            <label class="form-check-label" for="shift_change">Do you want to use Auto
                                                shift changing?</label>
                                        </div>
                                        <div class="form-group col-md-3" id="shift_turner"
