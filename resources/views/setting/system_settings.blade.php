...
<div class="row">
                                                    ...
                                                    <div class=" setting-card">
                                                        <div class="logo-content mt-4  setting-logo">
                                                                <a href="{{$logo.'logo-light.png'}}" target="_blank">
                                                                    <img id="image1" alt="your image" src="{{$logo.'logo-light.png'}}" width="150px" class="big-logo" style="filter: drop-shadow(2px 3px 7px #011c4b);">
                                                                </a>
                                                        </div>
                                                        ...
                                                        <div class="logo-content mt-4 setting-logo ">
                                                            {{-- <img src="{{ asset(Storage::url('uploads/logo/favicon.png')) }}"
                                                                ...
                                                                <a href="{{$logo.(isset($favicon) && !empty($favicon)? $favicon :'favicon.png')}}" target="_blank">
                                                                    <img id="image2" alt="your image" src="{{$logo.(isset($favicon) && !empty($favicon)? $favicon :'favicon.png')}}" width="50px" class="big-logo img_setting">
                                                                </a>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        {{ Form::text('currency_symbol', null, ['class' => 'form-control', 'id' => 'currency_symbol', 'required', 'placeholder' => __('Enter Currency Symbol')]) }}
                                    </div>
                                </div>
    ...
    <script>
        var country = document.getElementById('currency');
        var currency_symbol = document.getElementById('currency_symbol');
        country.addEventListener('keyup',function(){
            if(country.value == 'INR'){
                currency_symbol.value = '₹';
            // }
            // else if (country.value == 'UK' || country.value == 'EU'){
            //     currency_symbol.value = '£';
            }else{
                currency_symbol.value = '$';
            }
