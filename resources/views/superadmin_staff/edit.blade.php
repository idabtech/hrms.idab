{{ Form::model($user, ['route' => ['superadmin-staff.update', $user->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-12">
            ...
            @endphp
            <div class="form-icon-user">
                {!! Form::select('role', $roles, $userRoleId, ['class' => 'form-control', 'required' => 'required']) !!}
            </div>
        </div>
    </div>
</div>
