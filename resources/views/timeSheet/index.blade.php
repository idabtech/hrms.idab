...
@section('action-button')
    <a href="javascript:void(0)" data-url="{{ route('timesheet.file.import') }}" data-ajax-popup="true"
    ...
    @can('Create TimeSheet')
        <a href="javascript:void(0)" data-url="{{ route('timesheet.create') }}" data-ajax-popup="true" data-size="md"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::date('start_date', isset($_GET['start_date']) ? $_GET['start_date'] : null, ['class' => 'month-btn form-control  w-100', 'autocomplete' => 'off', 'id' => 'current_date']) }}
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            {{ Form::label('end_date', __('End Date'), ['class' => 'form-label']) }}
                                            {{ Form::date('end_date', isset($_GET['end_date']) ? $_GET['end_date'] : null, ['class' => 'month-btn form-control  w-100', 'autocomplete' => 'off', 'id' => 'current_date']) }}
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                            ...
                            <tbody>
                                ...
                                @foreach ($timeSheets as $timeSheet)
                                    <tr>
                                      ...
                                      <td>
                                        @if(strlen($timeSheet->remark) > 20)
                                            <span
                                                data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                                data-bs-custom-class="tooltip-primary"
                                                title="{{ $timeSheet->remark }}"
                                            >
                                                {{ \Illuminate\Support\Str::limit($timeSheet->remark, 20) }}
                                            </span>
                                        @else
                                            {{ $timeSheet->remark }}
                                        @endif
