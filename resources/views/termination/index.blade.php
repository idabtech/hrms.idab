...
@section('action-button')
    @can('Create Termination')
        <a href="javascript:void(0)" data-url="{{ route('termination.create') }}" data-ajax-popup="true"
                ...
                <div class="table-responsive">
                    <table class="table" id="pc-dt-simple">
                        ...
                        <tbody>
                            ...
                            <td><a href="javascript:void(0)" class="action-item" data-url="{{ route('termination.description',$termination->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Desciption')}}" data-title="{{__('Desciption')}}"><i class="fa fa-comment"></i></a>
                                    </td>
                                <td class="Action">
                                    @if (Gate::check('Edit Termination') || Gate::check('Delete Termination'))
                                        <span>
