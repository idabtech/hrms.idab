...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-lg-6 col-md-6">
            ...
            <a href="javascript:void(0)" data-title="{{ __('Create New Termination Type') }}" onclick="modalShow([{'name' : ''}], 'create-termination-type', 'Create Termination Type','termination-type')" data-bs-toggle="tooltip"
                title="{{ __('Create New Termination Type') }}" style="float: right" class="btn btn-sm btn-primary addBtn"
                data-bs-original-title="{{ __('Create') }}">
                <i class="ti ti-plus"></i>
            </a>
            {{ Form::select('termination_type', $terminationtypes, null, ['class' => 'form-control termination_type', 'required' => 'required']) }}
        </div>
        <div class="form-group col-lg-6 col-md-6">
            ...
            success: function (response) {
                ...
                switch (response.section) {
                    case 'termination_type':
                        $('.termination_type').html(response.output);
                        break;
                    default:
                        break;
                }
