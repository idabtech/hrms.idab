...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-lg-6 col-md-6">
            ...
            <a href="#" data-title="{{ __('Create New Termination Type') }}" onclick="modalShow([{'name' : ''}], 'create-termination-type', 'Create Termination Type','termination-type')" data-bs-toggle="tooltip"
