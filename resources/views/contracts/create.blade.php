...
<div class="modal-body">
    ...
    <div class="text-end">
        <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true" data-url="{{ route('generate', ['contract']) }}"
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="text-xs mt-1">
                    {{__('Create contract type.')}} <a href="{{route('contract_type.index')}}"><b>{{__('Click here')}}</b></a>
                </div>
            </div>
        </div>
