    ...
    <div class="col-md-12 text-end d-flex ">
        ...
        @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'hr' || \Auth::user()->type == 'HR')
            ...
            @can('Create Contract')
                ...
                <a href="javascript:void(0)" data-size="lg" data-url="{{ route('contracts.copy', $contract->id) }}"data-ajax-popup="true"
        ...
        @if (\Auth::user()->type == 'employee')
            <ul class="list-unstyled mb-0 m-1">
                <li class="dropdown dash-h-item drp-language">
                    <a class="dash-head-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="javascript:void(0)"
