...
@section('action-button')
    <div class="row align-items-center m-1">
        @can('Create Contract')
            <a href="javascript:void(0)" data-size="lg" data-url="{{ route('contract.create') }}" data-ajax-popup="true"
                                        ...
                                        @foreach ($contracts as $contract)
                                            <tr>
                                                ...
                                                <td class="Action">
                                                        ...
                                                        <div class="action-btn me-2">
                                                            <a href="{{ route('contract.show', \Illuminate\Support\Facades\Crypt::encrypt($contract->id)) }}"
                                                                class="mx-3 btn btn-sm bg-warning d-inline-flex align-items-center"
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                        ...
                                                        @can('Edit Contract')
                                                            <div class="action-btn me-2">
                                                                <a href="javascript:void(0)" data-size="lg"
                                                                    ...
                                                                    class="mx-3 btn btn-sm bg-info d-inline-flex align-items-center"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                        ...
                                                        @can('Delete Contract')
                                                            <div class="action-btn">
                                                                ...
                                                                data-bs-trigger="hover"
                                                                    class=" btn btn-sm bg-danger d-inline-flex align-items-center bs-pass-para"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="{{ __('Delete') }}">
