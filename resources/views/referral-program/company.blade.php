                ...
                <div class="col-xl-3">
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            <a href="javascript:void(0)" class="list-group-item list-group-item-action border-0 tab-link active"
                                data-tab="guideline">{{ __('GuideLine') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="javascript:void(0)" class="list-group-item list-group-item-action border-0 tab-link"
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-md-6 ">
                                    <div class = "border border-2 p-3">
                                        ...
                                        {{-- <p class="text-danger"><b>{{__('Note : ')}}</b>{{ __('Mimimum Withdrable Amount is ')  . $currency . (isset($setting) ? $setting->minimum_threshold_amount : '') }}</p> --}}
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 mt-5">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <a href="javascript:void(0)" class="btn btn-sm btn-light-primary w-100 cp_link"
                                            ...
                                            <div class="row align-items-center justify-content-between">
                                                <div class="col-auto mb-3 mb-sm-0">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-3">
                                                            <small class="text-muted">{{ __('Remain') }}</small>
                                                            <h6 class="m-0">{{ __('Remain Amount') }}</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-auto text-end">
                                                    <h4 class="m-0">{{ $currency . $netAmount }}
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($transaction->status == 0)
                                                            <span
                                                                class="status_badge badge bg-danger p-2 px-3 payout-status">{{ __(\App\Models\TransactionOrder::$status[$transaction->status]) }}</span>
                                                        @elseif($transaction->status == 1)
                                                            <span
                                                                class="status_badge badge bg-warning p-2 px-3 payout-status">{{ __(\App\Models\TransactionOrder::$status[$transaction->status]) }}</span>
                                                        @elseif($transaction->status == 2)
                                                            <span
                                                                class="status_badge badge bg-primary p-2 px-3 payout-status">{{ __(\App\Models\TransactionOrder::$status[$transaction->status]) }}</span>
                                                        @endif
                                                    </td>
