                ...
                <div class="card-body">
                    ...
                    <div class="">
                        <div class="form-group mb-3">
                            <label class="form-label">{{ __('Full Name') }}</label><span class="text-danger pl-1">*</span>
                            {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => __('Username'), 'required' => true]) }}
                        </div>
                        @error('name')
                        ...
                        @enderror
                        <div class="form-group mb-3">
                            <label class="form-label">{{ __('Email') }}</label><span class="text-danger pl-1">*</span>
                            {{ Form::text('email', null, ['class' => 'form-control', 'placeholder' => __('Email address'), 'required' => true]) }}
                        </div>
                        @error('email')
                        ...
                        @enderror
                        <div class="form-group mb-3">
                            <label class="form-label">{{ __('Mobile Number') }}</label><span
                                class="text-danger pl-1">*</span>
                            {{ Form::text('mobile', null, ['class' => 'form-control', 'placeholder' => __('Mobile'), 'required' => true]) }}
                        </div>
                        @error('mobile ')
                            <span class="error invalid-mobile number text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                        <div class="form-group mb-3">
                            <label class="form-label">{{ __('Password') }}</label><span class="text-danger pl-1">*</span>
                            {{ Form::password('password', ['class' => 'form-control', 'id' => 'input-password', 'placeholder' => __('Password'), 'required' => true]) }}
                        </div>
                        @error('password')
                        ...
                        <div class="form-group">
                            <label class="form-label">{{ __('Confirm password') }}</label><span
                                class="text-danger pl-1">*</span>
