    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <a href="javascript:void(0)" data-title="{{ __('Create New Department') }}" onclick="modalShow([{'branch': '{{$branch}}'}, {'name' : ''}], 'create-department','Create Department','department')" data-bs-toggle="tooltip"
                ...
                <div class="department_div">
                    ...
                    {{ Form::select('department_id[]', $departments, (!empty($announcement->department_id)) ? explode(",",$announcement->department_id) :null, ['class' => 'form-control department_id','multiple','id'=>'department_id']) }}
                </div>
            </div>
        </div>
