...
@section('action-button')
    <a href="javascript:void(0)" class="btn btn-sm btn-primary me-2" onclick="saveAsPDF()" data-bs-toggle="tooltip" title="{{ __('Download') }}"
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box" id="department_div">
                                            ...
                                            <select class="form-control select department_id" name="department"
                                                id="department_id" placeholder="{{ __('Select Department') }}">
                                                <option value="">{{ __('All') }}</option>
                                                @foreach($department as $id => $name)
                                                    <option value="{{ $id }}" {{ isset($_GET['department']) && $_GET['department'] == $id ? 'selected' : '' }}>{{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <td>
                                        <div class="btn btn-sm btn-danger badge">{{ $leave['reject'] }}
                                            <a href="javascript:void(0)" class="text-white"
                                                ...
                                                class="table-action table-action-delete" data-size="xl"
