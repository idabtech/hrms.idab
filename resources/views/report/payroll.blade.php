...
@section('action-button')
    <div class="float-end">
        <a href="javascript:void(0)" class="btn btn-sm btn-primary me-2" onclick="saveAsPDF()" data-bs-toggle="tooltip"
    ...
    <div class="row">
        ...
        <div id="printableArea">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3">
                    <div class="card p-4 mb-4">
                        <h6 class="report-text gray-text mb-0">{{ __('Total Statutory Deductions') }} :</h6>
                            ...
                            <tbody>
                                @foreach ($payslips as $payslip)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($payslip->status == 0)
                                                <div class="badge bg-danger p-2 px-3 badge payroll-set"><a href="javascript:void(0)"
                                                        class="text-white">{{ __('UnPaid') }}</a></div>
                                            @else
                                                <div class="badge bg-success p-2 px-3 badge payroll-set"><a href="javascript:void(0)"
