...
@section('action-button')
    @can('Create Travel')
        <a href="javascript:void(0)" data-url="{{ route('travel.create') }}" data-ajax-popup="true" data-title="{{ __('Create New Trip') }}"
                            ...
                            <tbody>
                                ...
                                @foreach ($travels as $travel)
                                    <tr>
                                        ...
                                        <td class="description-col" data-description="{{ $travel->description }}"></td>
                                        <td class="Action">
                                            @if (Gate::check('Edit Travel') || Gate::check('Delete Travel'))
                                                        @can('Edit Travel')
