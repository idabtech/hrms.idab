...
@section('action-button')
    <div class="row align-items-center m-1">
        ...
        {{-- <div class="col-auto pe-0">
            <a href="javascript:void(0)" class="btn btn-sm btn-primary btn-icon" data-size="md"
        ...
        @if ($currantLang != \App\Models\Utility::settings()['default_language'])
            <div class="col-auto pe-0">
                ...
                <a href="javascript:void(0)" class="btn btn-sm btn-danger btn-icon bs-pass-para" data-bs-toggle="tooltip"
