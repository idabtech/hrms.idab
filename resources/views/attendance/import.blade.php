...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12 mb-6">
            {{Form::label('file',__('Download sample attendance CSV file'),['class'=>'form-label'])}}
...
<div class="modal-footer">
    ...
    <a href="javascript:void(0)" data-url="" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Attendance CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
{{ Form::close() }}
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.error != '')
                {
                    ...
                    let url = "{{ route('attendance.import.modal') }}";
