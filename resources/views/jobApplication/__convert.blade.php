    ...
    <div class="col-md-6 ">
        <div class="card card-fluid">
            ...
            <div class="card-body employee-detail-create-body">
                ...
                @php $docType = $document->document_type ?? 'file'; @endphp
                    <div class="row">
                        <div class="form-group col-12">
                            <label class="float-left pt-1 form-label">{{ $document->name }}
        ...
        <div class="card card-fluid">
            ...
            <div class="card-body employee-detail-create-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        {!! Form::label('bank_identifier_code', __(\App\Models\Utility::bankCodeLabel()), ['class' => 'col-form-label']) !!}
                        {!! Form::text('bank_identifier_code', old('bank_identifier_code'), ['class' => 'form-control', 'placeholder' => __(\App\Models\Utility::bankCodeLabel())]) !!}
                    </div>
                    <div class="form-group col-md-6">
