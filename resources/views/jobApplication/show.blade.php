                            ...
                            <div>
                                ...
                                <a href="{{ !empty($jobApplication->profile) ? $profiles . $jobApplication->profile : $logo . 'avatar.png' }}"
                                    ...
                                    <img src="{{ !empty($jobApplication->profile) ? $profiles . $jobApplication->profile : $logo . 'avatar.png' }}"
                                        class="img-fluid rounded border-2 border border-primary" width="55px"
                                        style="height: 55px">
                                </a>
                            </div>
                                ...
                                <div class="dt-buttons">
                                    <span class="text-sm action-btn bg-primary me-2">
                                        <a href="{{ $resumes . '/' . $jobApplication->resume }}" data-bs-toggle="tooltip"
                                            data-bs-original-title="{{ __('download') }}" download=""><span class="text-white"><i
                                                class="ti ti-download "></i></span></a>
                                    </span>
                                    <div class="action-btn bg-secondary ">
                                        <a class="mx-3 btn btn-sm align-items-center"
                                            href="{{ $resumes . '/' . $jobApplication->resume }}" target="_blank">
                                            <span class="text-white"><i class="ti ti-crosshair " data-bs-toggle="tooltip"
