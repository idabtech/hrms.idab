    ...
    <div class="row">
        @if (\Auth::user()->type != 'employee')
            <div class="form-group col-md-6 col-lg-6">
                ...
                {{ Form::select('complaint_from', $employees_by, null, ['class' => 'form-control  select2','id'=>'complaint_from', 'required' => 'required']) }}
            </div>
        @endif
        <div class="form-group col-md-6 col-lg-6">
            {{ Form::label('complaint_against', __('Complaint Against'), ['class' => 'col-form-label']) }}<x-required></x-required>
            {{ Form::select('complaint_against', $employees_to, null, ['class' => 'form-control' ,'id'=>'complaint_against','required' => 'required']) }}
        </div>
        <div class="form-group col-md-6 col-lg-6">
