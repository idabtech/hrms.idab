    ...
    public function index()
    {
        if(Auth::check())
        {
            ...
            if($user->type == 'employee')
            {
                ...
                $shift_time = Shift::where('id', '=', \Auth::user()->employee->shift_id)->first();
                // echo "<pre>"; print_r(\Auth::user()->employee->shift_id); exit;
                return view('dashboard.dashboard', compact('arrEvents', 'announcements', 'employees', 'meetings', 'employeeAttendance', 'shift_time'));
            }
