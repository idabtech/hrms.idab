    ...
    public function index(Request $request)
    {
        ...
        if (\Auth::user()->type == 'company' || \Auth::user()->type == 'super admin') {
            if ($user->type == 'super admin') {
                ...
                return view('setting.system_settings', compact('settings', 'admin_payment_setting', 'shift_turner'));
            } else {
                ...
                return view('setting.company_settings', compact('settings', 'timezones', 'ips', 'shift_turner', 'EmailTemplates', 'currOfferletterLang', 'Offerletter', 'offerlang', 'Joiningletter', 'currjoiningletterLang', 'joininglang', 'experience_certificate', 'curr_exp_cetificate_Lang', 'explang', 'noc_certificate', 'currnocLang', 'noclang'));
            }
        } else {
