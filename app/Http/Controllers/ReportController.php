...
class ReportController extends Controller
{
            ...
            foreach ($employees as $id => $employee) {
                ...
                foreach ($dates as $date) {
                    ...
                    if ($dateFormat <= date('Y-m-d')) {
                        // $employeeAttendance = AttendanceEmployee::where(['employee_id' => $id,'created_by' => Auth::user()->creatorId()])->where('date', $dateFormat)->first();
    ...
    public function timesheet(Request $request)
    {
        if (Auth::user()->can('Manage Report')) {
            ...
            // print_r($timesheetFilters->created_by); exit;
            // dd($timesheets);
    ...
    public function exportTimeshhetReport($start_date, $end_date, $branch, $department)
    {
        ...
        $data = Excel::download(new TimesheetReportExport($start_date, $end_date, $branch, $department), $name . '.xlsx');
    ...
    public function exportCsv($filter_month, $branch, $department)
    {
        ...
        $data = Excel::download(new MonthlyAttendanceExport($month, $year, $branch, $department), $name . '.xlsx');
