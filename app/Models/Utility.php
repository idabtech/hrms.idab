...
class Utility extends Model
{
    ...
    {
        // Top priority countries for quick selection & Hub SSO matching
        $topCountries = [
        ...
        // All remaining countries listed alphabetically
        $otherCountries = [
        ...
        return array_merge($topCountries, $otherCountries);
    }
