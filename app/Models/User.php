...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public static function defaultEmail()
    {
        ...
        $defaultTemplate = [
            ...
            'attendance_request' => [
                ...
                'lang' => [
                    'ar' => '<p>مرحباً {receiver_name} الموارد البشرية/المالك،</p>
                        <p>{employee_name} قدّم طلباً بخصوص <strong>{type}</strong> بتاريخ {date} في {time}.</p>
                        <p><strong>السبب:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">عرض الطلب</a>
                        </p>
                        <p>شكراً لك</p>
                        <p><strong>مع التحية،</strong><br>{app_name}</p>',

                    'da' => '<p>Hej {receiver_name} HR/Ejer,</p>
                        <p>{employee_name} har indsendt en anmodning om <strong>{type}</strong> den {date} kl. {time}.</p>
                        <p><strong>Årsag:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">Se anmodning</a>
                        </p>
                        <p>Tak</p>
                        <p><strong>Venlig hilsen,</strong><br>{app_name}</p>',

                    'de' => '<p>Hallo {receiver_name} HR/Inhaber,</p>
                        <p>{employee_name} hat eine Anfrage für <strong>{type}</strong> am {date} um {time} eingereicht.</p>
                        <p><strong>Grund:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">Anfrage anzeigen</a>
                        </p>
                        <p>Vielen Dank</p>
                        <p><strong>Mit freundlichen Grüßen,</strong><br>{app_name}</p>',
                    ...
                    'es' => '<p>Hola {receiver_name} RRHH/Propietario,</p>
                        <p>{employee_name} ha enviado una solicitud de <strong>{type}</strong> para el {date} a las {time}.</p>
                        <p><strong>Razón:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">Ver solicitud</a>
                        </p>
                        <p>Gracias</p>
                        <p><strong>Atentamente,</strong><br>{app_name}</p>',

                    'fr' => '<p>Bonjour {receiver_name} RH/Propriétaire,</p>
                        <p>{employee_name} a soumis une demande de <strong>{type}</strong> le {date} à {time}.</p>
                        <p><strong>Raison :</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">Voir la demande</a>
                        </p>
                        <p>Merci</p>
                        <p><strong>Cordialement,</strong><br>{app_name}</p>',

                    'it' => '<p>Ciao {receiver_name} HR/Titolare,</p>
                        <p>{employee_name} ha inviato una richiesta di <strong>{type}</strong> per il {date} alle {time}.</p>
                        <p><strong>Motivo:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">Visualizza richiesta</a>
                        </p>
                        <p>Grazie</p>
                        <p><strong>Saluti,</strong><br>{app_name}</p>',

                    'ja' => '<p>{receiver_name} 人事/オーナー様,</p>
                        <p>{employee_name} が <strong>{type}</strong> の申請を {date} の {time} に提出しました。</p>
                        <p><strong>理由:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">リクエストを見る</a>
                        </p>
                        <p>ありがとうございます。</p>
                        <p><strong>敬具</strong><br>{app_name}</p>',

                    'nl' => '<p>Hallo {receiver_name} HR/Eigenaar,</p>
                        <p>{employee_name} heeft een verzoek ingediend voor <strong>{type}</strong> op {date} om {time}.</p>
                        <p><strong>Reden:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">Bekijk verzoek</a>
                        </p>
                        <p>Dank u</p>
                        <p><strong>Met vriendelijke groet,</strong><br>{app_name}</p>',

                    'pl' => '<p>Cześć {receiver_name} HR/Właścicielu,</p>
                        <p>{employee_name} złożył wniosek o <strong>{type}</strong> w dniu {date} o godzinie {time}.</p>
                        <p><strong>Powód:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">Zobacz wniosek</a>
                        </p>
                        <p>Dziękuję</p>
                        <p><strong>Z poważaniem,</strong><br>{app_name}</p>',

                    'ru' => '<p>Здравствуйте, {receiver_name} HR/Владелец,</p>
                        <p>{employee_name} подал запрос на <strong>{type}</strong> {date} в {time}.</p>
                        <p><strong>Причина:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">Просмотреть запрос</a>
                        </p>
                        <p>Спасибо</p>
                        <p><strong>С уважением,</strong><br>{app_name}</p>',

                    'pt' => '<p>Olá {receiver_name} RH/Proprietário,</p>
                        <p>{employee_name} enviou uma solicitação de <strong>{type}</strong> em {date} às {time}.</p>
                        <p><strong>Motivo:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">Ver Solicitação</a>
                        </p>
                        <p>Obrigado</p>
                        <p><strong>Atenciosamente,</strong><br>{app_name}</p>',

                    'tr' => '<p>Merhaba {receiver_name} İK/Sahip,</p>
                        <p>{employee_name} {date} tarihinde saat {time} için <strong>{type}</strong> talebi göndermiştir.</p>
                        <p><strong>Neden:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">Talebi Görüntüle</a>
                        </p>
                        <p>Teşekkürler</p>
                        <p><strong>Saygılarımızla,</strong><br>{app_name}</p>',

                    'zh' => '<p>您好 {receiver_name} 人力资源/负责人,</p>
                        <p>{employee_name} 已于 {date} {time} 提交了 <strong>{type}</strong> 请求。</p>
                        <p><strong>原因:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">查看请求</a>
                        </p>
                        <p>谢谢</p>
                        <p><strong>此致敬礼,</strong><br>{app_name}</p>',

                    'he' => '<p>שלום {receiver_name} משאבי אנוש/בעלים,</p>
                        <p>{employee_name} הגיש בקשה ל-<strong>{type}</strong> בתאריך {date} בשעה {time}.</p>
                        <p><strong>סיבה:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">צפה בבקשה</a>
                        </p>
                        <p>תודה</p>
                        <p><strong>בברכה,</strong><br>{app_name}</p>',

                    'pt-br' => '<p>Olá {receiver_name} RH/Proprietário,</p>
                        <p>{employee_name} enviou uma solicitação de <strong>{type}</strong> em {date} às {time}.</p>
                        <p><strong>Motivo:</strong> {reason}</p>
                        <p style="text-align:center">
                            <a style="background:#6676ef;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;" href="{url}" target="_blank">Ver Solicitação</a>
    ...
    public function companyHrs()
    {
        ...
        $userHr = User::where('created_by', '=', Auth::user()->creatorId())->where('type', '=', 'hr')->get();
    ...
    public function priceFormat($price)
    {
        ...
        // return (($settings['site_currency_symbol_position'] == "pre") ? ( $user->currency_symbol ?? $settings['site_currency_symbol']) : '') . number_format($price, 2) . (($settings['site_currency_symbol_position'] == "post") ? ($user->currency_symbol ?? $settings['site_currency_symbol']) : '');
    }
    ...
    public function currencySymbol()
    {
        ...
        // return $user->currency_symbol ?? $settings['site_currency_symbol'];
    }
