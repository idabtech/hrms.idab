...
class UsersTableSeeder extends Seeder
{
    public function run()
    {
        $arrPermissions = [
            ...
            [
                "name" => "Login Enable Disable User",
                "guard_name" => "web",
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
            ...
            [
                "name" => "Create Subdepartment",
                "guard_name" => "web",
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
            [
                "name" => "Edit Subdepartment",
                "guard_name" => "web",
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
            [
                "name" => "Delete Subdepartment",
                "guard_name" => "web",
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
            ...
            [
                "name" => "Manage Attendance Request",
                "guard_name" => "web",
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
            [
                "name" => "Approve Attendance Request",
                "guard_name" => "web",
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
            [
                "name" => "Decline Attendance Request",
                "guard_name" => "web",
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
            [
                "name" => "Edit Attendance Request",
                "guard_name" => "web",
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
        ...
        Permission::upsert($arrPermissions, ['name'], ['guard_name', 'updated_at']);
        ...
        $superAdmin = User::updateOrCreate(
            ['email' => 'idabtechs@gmail.com'],
            [
                'name' => 'Super Admin',
                'password' => Hash::make('Karma@2025$'),
                'type' => 'super admin',
                'lang' => 'en',
                'avatar' => '',
        ...
        $company = User::updateOrCreate(
            ['email' => 'info@idabtech.com'],
            [
                'name' => 'company',
                'password' => Hash::make('CompanyKarma@2025$'),
                'email_verified_at' => now(),
                'type' => 'company',
                'lang' => 'en',
                'avatar' => '',
        ...
        $hr = User::updateOrCreate(
            ['email' => 'hr@idabtech.com'],
            [
                'name' => 'hr',
                'password' => Hash::make('HrKarma@2025$'),
                'email_verified_at' => now(),
                'type' => 'hr',
                'lang' => 'en',
                'avatar' => '',
        ...
        $settings = [
            ...
            ['name' => 'enable_cookie', 'value' => 'on'],
            ['name' => 'cookie_logging', 'value' => 'on'],
            ['name' => 'cookie_title', 'value' => 'We use cookies!'],
            ['name' => 'cookie_description', 'value' => 'Hi, this website uses essential cookies to ensure its proper operation and tracking cookies to understand how you interact with it'],
            ['name' => 'necessary_cookies', 'value' => 'on'],
            ['name' => 'strictly_cookie_title', 'value' => 'Strictly necessary cookies'],
            ['name' => 'strictly_cookie_description', 'value' => 'These cookies are essential for the proper functioning of my website. Without these cookies, the website would not work properly'],
            ['name' => 'more_information_description', 'value' => 'For any queries in relation to our policy on cookies and your choices, please contact us'],
            ['name' => 'contactus_url', 'value' => '#'],
        ];
