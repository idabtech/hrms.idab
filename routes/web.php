...
Route::get('/excelsheet',[ReportController::class, 'test'])->middleware(['XSS']);
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::post('employee/shift', [EmployeeController::class, 'json'])->name('employee.shift')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    // Route::resource('subdepartment', SubDepartmentController::class)->middleware(
    //     [
    //         'auth',
    //         'XSS',
    //     ]
...
/*******************************************end subcategory***************************************** */
    ...
    Route::get('import/attendence/file', [AttendanceEmployeeController::class, 'importAttendanceFile'])->name('attendence.file.import');
    Route::post('import/attendence', [AttendanceEmployeeController::class, 'attendenceImport'])->name('attendence.import');
    ...
    Route::resource('timesheet', TimeSheetController::class)->middleware(
        ...
        // Route::resource('shift-turner', ShiftTurnerController::class)->middleware(
    //     [
    //         'auth',
    //         'XSS',
    //     ]
    ...
    Route::get('timesheet/export/{start_date}/{end_date}/{branch}/{department}', [ReportController::class, 'exportTimeshhetReport'])->name('timesheet.report.export');
    ...
    Route::post('payslip-department', [PaySlipController::class, 'getEmployeeByDepartment'])->name('payslip.getdepartment');
...
Route::get('wegis-index',[WegisController::class,'index'])->name('wegis.index')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('wegis-create',[WegisController::class,'create'])->name('wegis.create')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('wegis-store',[WegisController::class,'save'])->name('wegis-store')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('edit-wegis/{id}',[WegisController::class,'edit'])->name('edit-wegis')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('wegis-update',[WegisController::class,'update'])->name('wegis.update')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('wegis-delete/{id}',[WegisController::class,'delete'])->name('wegis.delete')->middleware(
    [
        'auth',
        'XSS',
    ]
