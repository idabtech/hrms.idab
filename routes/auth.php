...
Route::get('/register/otp-verification', [RegisteredUserController::class, 'genrateOtp'])
                ->middleware('guest')
                ->name('genrate.otp');
...
Route::get('/verify', [AuthenticatedSessionController::class, 'showPopup'])
                // ->middleware('guest')
                ->name('show.popup');
Route::get('/verify/document', [AuthenticatedSessionController::class, 'checkDocument'])
                // ->middleware('guest')
                ->name('checkdocument');
...
Route::post('/otp/verification', [RegisteredUserController::class, 'otpVerification'])->name('otp.verification');
